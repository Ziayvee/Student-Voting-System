	...
	<div class="container  clearfix">
		<div class="one-third1 column">
			<ul>
				...
				<li class="active"><a href="course.php"><img alt="" ><span>Course</span></a></li>
		...
		<div class="two-thirds1 column">
			...
			<a rel="facebox" href="addcourse.php"> Add Course </a>
			<table id="resultTable" data-responsive="table">
				...
				<tbody>
					...
					<tr class="record">
						...
						<td><a rel="facebox" href="editcourse.php?id=<?php echo $row['id']; ?>"> Edit </a> | <a href="#" id="<?php echo $row['id']; ?>" class="delbutton" title="Click To Delete">Delete</a></td>
					</tr>
					<?php
						}
					?>
