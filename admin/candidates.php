	...
	<div class="container  clearfix">
		<div class="one-third1 column">
			<ul>
				...
				<li class="active"><a href="candidates.php"><img alt="" ><span>Candidates</span></a></li>
		...
		<div class="two-thirds1 column">
			...
			<table id="resultTable" data-responsive="table">
				...
				<tbody>
					...
					?>
					<tr class="record">
						<td><a rel="facebox" href="editphoto.php?id=<?php echo $row['id']; ?>"><img src="candidates/<?php echo $row['image']; ?>" width="150px" height="150px"/></a></td>
